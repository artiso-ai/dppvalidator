"""Backward-compatibility re-export of v0.6.x ``credential``.

The actual class definitions live in :mod:`dppvalidator.models.v0_6.credential`.
This shim preserves the import path used by third-party plugins (e.g.
``from dppvalidator.models.credential import CredentialIssuer``) — see Phase 3 of
