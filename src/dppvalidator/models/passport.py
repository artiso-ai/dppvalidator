"""Backward-compatibility re-export of v0.6.x ``passport``.

The actual class definitions live in :mod:`dppvalidator.models.v0_6.passport`.
This shim preserves the import path used by third-party plugins (e.g.
``from dppvalidator.models.passport import DigitalProductPassport``) — see Phase 3 of
...
from dppvalidator.models.v0_6.passport import (
