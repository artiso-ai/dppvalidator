"""Backward-compatibility re-export of v0.6.x ``performance``.

The actual class definitions live in :mod:`dppvalidator.models.v0_6.performance`.
This shim preserves the import path used by third-party plugins (e.g.
``from dppvalidator.models.performance import CircularityPerformance``) — see Phase 3 of
