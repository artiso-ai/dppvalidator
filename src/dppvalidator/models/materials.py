"""Backward-compatibility re-export of v0.6.x ``materials``.

The actual class definitions live in :mod:`dppvalidator.models.v0_6.materials`.
This shim preserves the import path used by third-party plugins (e.g.
``from dppvalidator.models.materials import Material``) — see Phase 3 of
...
from dppvalidator.models.v0_6.materials import (
    Material,
)
