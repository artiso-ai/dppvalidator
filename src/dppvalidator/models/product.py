"""Backward-compatibility re-export of v0.6.x ``product``.

The actual class definitions live in :mod:`dppvalidator.models.v0_6.product`.
This shim preserves the import path used by third-party plugins (e.g.
``from dppvalidator.models.product import Characteristics``) — see Phase 3 of
...
from dppvalidator.models.v0_6.product import (
    Characteristics,
    Dimension,
    Product,
)
